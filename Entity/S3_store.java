...
public class S3_store {


    public static void main(String[] args) {
        AWSCredentials credentials = new BasicAWSCredentials("AKIAJOESSYAPQLHLVIYA","kfZu32KkxhGK7KNcQaMlniPY+aA9zchAfIeBdfNL");
        ...
        String QueueName = "star-s3-str-res";
